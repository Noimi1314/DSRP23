...
## Encodinf categories as factprs or integers
# If a categorical variable is a character, make it factor
...
# choose which variables you want to ise as features in your model
# For iris data ...
...
# 3. Make you training and testing splits
...
class_results$lm.pred <- predict(log_fit, class_test)$.pred_class
class_results$boost.pred <- predict(boost_fit, class_test)$.pred_class
class_results$forest.pred <- predict(forest_class_fit, class_test)$.pred_class
